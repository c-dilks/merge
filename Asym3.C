        ...
        for(Int_t p=0; p<pt_bins; p++)
        {
          for(Int_t e=0; e<en_bins; e++)
          {
            ...
            for(Int_t r=0; r<ARR_size; r++)
            {
              ...
              {
                rellum = RD12->Rellum(runnum,a,"vpd"); // note that asym no. = rellum no. needed for this asymmetry
                scarat = RD12->Scarat(runnum,"x",s);
              ...
              {
                rellum = RD13->Rellum(runnum,a,"vpd"); // note that asym no. = rellum no. needed for this asymmetry
                scarat = RD13->Scarat(runnum,"x",s);
